...
import com.lzq.echarts.code.Align;
import com.lzq.echarts.code.LegendType;
...
public class Legend extends Basic<Legend> implements Data<Legend>, Component {
     ...
     *
     * @see com.lzq.echarts.code.Orient
     */
     ...
     * 选择模式，默认开启图例开关
     *
     * @see com.lzq.echarts.code.SelectedMode
     */
     ...
     *
     * @see com.lzq.echarts.data.LegendData
     */
    private List data;
     ...
     * @param values
     */
    public Legend(Collection values) {
        this.data(values);
    }
     ...
     * @return
     */
    public Legend data(Collection values) {
