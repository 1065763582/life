...
import com.lzq.echarts.Label;
import com.lzq.echarts.Title;
import com.lzq.echarts.axis.AxisLine;
import com.lzq.echarts.axis.AxisTick;
import com.lzq.echarts.axis.SplitLine;
import com.lzq.echarts.code.SeriesType;
import com.lzq.echarts.series.gauge.Detail;
import com.lzq.echarts.series.gauge.Pointer;
...
public class Gauge extends Series<Gauge> {
     ...
     * 坐标轴线，默认显示
     *
     * @see com.lzq.echarts.series.Line
     */
     ...
     * 指针样式
     *
     * @see com.lzq.echarts.series.gauge.Pointer
     */
    private Pointer pointer;
    /**
     * 仪表盘标题
     *
     * @see com.lzq.echarts.Title
     */
    private Title title;
    /**
     * 仪表盘详情
     *
     * @see com.lzq.echarts.series.gauge.Detail
     */
